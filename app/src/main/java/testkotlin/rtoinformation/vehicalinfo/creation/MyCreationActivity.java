package testkotlin.rtoinformation.vehicalinfo.creation;
...
import testkotlin.rtoinformation.vehicalinfo.Activities.MyHistoryDetails;
import testkotlin.rtoinformation.vehicalinfo.Activities.RTOSymbolsDetailActivity;
import testkotlin.rtoinformation.vehicalinfo.BuildConfig;
...
public class MyCreationActivity extends AppCompatActivity implements MycreationAdapter.OnrvgalleyItemClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(MyCreationActivity.this).showBanner(adMobView, AppManage.ADMOB_B[0], AppManage.FACEBOOK_B[0]);
    ...
    public void OnGalleyDeleteItemClick(final int position) {
        new AlertDialog.Builder(this).setMessage("Do you want to delete this vehicle detail?").setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            /* class testkotlin.rtoinformation.vehicalinfo.Activities.MyVehicleInfoActivity.Passport_Photo_Adpater.AnonymousClass2.AnonymousClass2 */
            ...
            /* class testkotlin.rtoinformation.vehicalinfo.Activities.MyVehicleInfoActivity.Passport_Photo_Adpater.AnonymousClass2.AnonymousClass1 */
