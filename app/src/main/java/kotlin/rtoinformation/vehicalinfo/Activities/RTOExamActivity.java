...
import kotlin.rtoinformation.vehicalinfo.utils.ProgressWheel;

import kotlin.rtoinformation.vehicalinfo.Examdata.RTOExamData;
import kotlin.rtoinformation.vehicalinfo.R;
import kotlin.rtoinformation.vehicalinfo.RTOExamDatabase.RTO_Question;
...
public class RTOExamActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        AppManage.getInstance(RTOExamActivity.this).showBanner(adMobView, AppManage.ADMOB_B[0], AppManage.FACEBOOK_B[0]);
...
//                    }
    ...
    public void initializeTimerTask() {
        this.timerTask = new TimerTask() {
            /* class kotlin.rtoinformation.vehicalinfo.Activities.RTOExamActivity.AnonymousClass8 */
