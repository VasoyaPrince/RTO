...
import kotlin.rtoinformation.vehicalinfo.Adapter.CityListAdapter;
...
public class CityListActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        AppManage.getInstance(CityListActivity.this).showBanner(adMobView, AppManage.ADMOB_B[0], AppManage.FACEBOOK_B[0]);
