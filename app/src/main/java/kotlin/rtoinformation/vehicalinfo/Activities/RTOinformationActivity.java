...
import kotlin.rtoinformation.vehicalinfo.Adapter.Searchadapter;
import kotlin.rtoinformation.vehicalinfo.Database.DBHelper;
import kotlin.rtoinformation.vehicalinfo.Database.DatabaseAccess;
...
public class RTOinformationActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        AppManage.getInstance(RTOinformationActivity.this).showBanner(adMobView, AppManage.ADMOB_B[0], AppManage.FACEBOOK_B[0]);
