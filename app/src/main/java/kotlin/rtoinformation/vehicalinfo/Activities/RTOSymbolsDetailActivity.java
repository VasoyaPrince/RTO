...
import kotlin.rtoinformation.vehicalinfo.Adapter.RTOSymbolAdapter;
...
public class RTOSymbolsDetailActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        AppManage.getInstance(RTOSymbolsDetailActivity.this).showBanner(adMobView, AppManage.ADMOB_B[0], AppManage.FACEBOOK_B[0]);
