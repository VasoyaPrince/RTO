...
import kotlin.rtoinformation.vehicalinfo.Process.GpsTracker;
import kotlin.rtoinformation.vehicalinfo.R;
import kotlin.rtoinformation.vehicalinfo.RTOExamDatabase.RTO_Variable;
import kotlin.rtoinformation.vehicalinfo.Splash.Spalsh_StartActivity;
import kotlin.rtoinformation.vehicalinfo.creation.MyCreationActivity;

public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    public static ArrayList<String> dataModel;
    public static Boolean isexam = false;
    public static Bitmap f0xyz;
    ...
    public void onCreate(Bundle bundle) {
        ...
        AppManage.getInstance(MainActivity.this).showBanner(adMobView, AppManage.ADMOB_B[0], AppManage.FACEBOOK_B[0]);
        ...
        rto_information =  findViewById(R.id.rto_information);
        rto_information.setOnClickListener(view -> AppManage.getInstance(MainActivity.this).showInterstitialAd(MainActivity.this, () -> {
