...
public class RTOSymbolsActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        AppManage.getInstance(RTOSymbolsActivity.this).showBanner(adMobView, AppManage.ADMOB_B[0], AppManage.FACEBOOK_B[0]);
        ...
        this.cautionary_option.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                AppManage.getInstance(RTOSymbolsActivity.this).showInterstitialAd(RTOSymbolsActivity.this, () -> {
                    openinfoactivity("Cautionary" , R.drawable.ic_symbolcau);
        ...
        this.mandatory_option.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                AppManage.getInstance(RTOSymbolsActivity.this).showInterstitialAd(RTOSymbolsActivity.this, () -> {
                    openinfoactivity("Mandatory" , R.drawable.ic_signman);
                }, "", AppManage.app_mainClickCntSwAd);
            }
        });
        ...
        this.roadsingnals_option.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                AppManage.getInstance(RTOSymbolsActivity.this).showInterstitialAd(RTOSymbolsActivity.this, () -> {
                    openinfoactivity("Road & Signals" ,R.drawable.ic_trafficroadsign);
                }, "", AppManage.app_mainClickCntSwAd);
            }
        });
