...
import kotlin.rtoinformation.vehicalinfo.Adapter.IRecyclerViewClickListener;
import kotlin.rtoinformation.vehicalinfo.Adapter.IRecyclerViewLongClickListener;
import kotlin.rtoinformation.vehicalinfo.Adapter.RecentSearchHistoryAdapter;
...
import kotlin.rtoinformation.vehicalinfo.helpers.ToastHelper;
import kotlin.rtoinformation.vehicalinfo.utils.Utils;
import kotlin.rtoinformation.vehicalinfo.widget.BaseBottomSheet;
...
public class SearchVehicleActivity extends AppCompatActivity implements IRecyclerViewClickListener, IRecyclerViewLongClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.btnSearchDetails.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                AppManage.getInstance(SearchVehicleActivity.this).showInterstitialAd(SearchVehicleActivity.this, () -> {
                    if (isValidRegistrationNo()) {
                        ToastHelper.showToast(SearchVehicleActivity.this, "Please enter vehicle registration number", false);
                    } else {
                        btnSearchVehicleDetailsClickListener(etFirst.getText().toString());
                    }
