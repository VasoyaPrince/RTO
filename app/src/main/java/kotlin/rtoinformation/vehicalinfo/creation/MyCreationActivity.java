package kotlin.rtoinformation.vehicalinfo.creation;
...
import kotlin.rtoinformation.vehicalinfo.Activities.MyHistoryDetails;
import kotlin.rtoinformation.vehicalinfo.Activities.RTOSymbolsDetailActivity;
...
public class MyCreationActivity extends AppCompatActivity implements MycreationAdapter.OnrvgalleyItemClick {
    ...
    public void OnGalleyDeleteItemClick(final int position) {
        new AlertDialog.Builder(this).setMessage("Do you want to delete this vehicle detail?").setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            /* class kotlin.rtoinformation.vehicalinfo.Activities.MyVehicleInfoActivity.Passport_Photo_Adpater.AnonymousClass2.AnonymousClass2 */
            ...
            /* class kotlin.rtoinformation.vehicalinfo.Activities.MyVehicleInfoActivity.Passport_Photo_Adpater.AnonymousClass2.AnonymousClass1 */
